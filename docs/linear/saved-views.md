...
| **Cestovni — Stage 5 delivery** | Project **Cestovni** + Parent **CES-35** (Delivery v1 epic). Shows the 12 vertical children in dependency order. **Repo:** M0 verticals (CES-36/CES-37) implemented under `client/` + `tests/client-db/` — see `docs/product/delivery-plan-v1.md` status + “Repo status” column. |
