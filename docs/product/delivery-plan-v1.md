...
**Recommended next coding work:** **[CES-40](https://linear.app/personal-interests-llc/issue/CES-40) Photo pipeline** — last remaining M1 vertical after **CES-67 Maintenance** shipped. Parallel ops: **[CES-63](https://linear.app/personal-interests-llc/issue/CES-63)** iPhone install-doc + T1; **[CES-68](https://linear.app/personal-interests-llc/issue/CES-68)** Android APK anytime for demo distribution.

| Track | Issue | Why now | Done when |
| ----- | ----- | ------- | --------- |
| **A — M1 photos** | **[CES-40](https://linear.app/personal-interests-llc/issue/CES-40)** | Last M1 feature vertical; Maint/Metrics/Log complete | EXIF strip + TTL + `photo_refs` per `photo-pipeline.md` |
...
Linear: **Critical gaps** all **Done** (repo + board). **CES-39 Done** on `main` and Linear (2026-07-17). **CES-65 + CES-66 Done** (repo + Linear 2026-07-22). **CES-67 Done** (2026-08-15). Open M1 vertical: **[CES-40](https://linear.app/personal-interests-llc/issue/CES-40)** (photos).
...
- 🟨 M0 + M1 land: offline app runs, fill-up works end-to-end, golden math tests green. *(**M0 closed**. **M1 core closed** (CES-38/39/57 Done). **CES-65/66/67 Done**. **Open:** CES-40 — see [Current focus](#current-focus).)*
