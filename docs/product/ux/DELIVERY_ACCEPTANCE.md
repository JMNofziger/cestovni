...
**M1 / CES-39:** Gate closed; **CES-39 Done** (repo + Linear). **CES-57 Done.** **CES-65 Done** (prefs display). **CES-66 Done** (Metrics). **CES-67 Done** (Maint tab + History Maint, 2026-08-15). **Still open:** photo (**CES-40**). See [`../delivery-plan-v1.md`](../delivery-plan-v1.md).
