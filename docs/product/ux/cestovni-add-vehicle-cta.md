...
- **Components:** Header vehicle selector and no-vehicle empty states are implemented in `client/lib/app/shell.dart`, `log_page.dart`, and `history_page.dart` (CES-39). Logical names in screenshots may differ from private widget class names.
