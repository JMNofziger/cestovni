...
- **Scope:** visual reference for target screens. **Repo:** Log, History, vehicle flows (CES-39), prefs display (CES-65), Metrics (CES-66), Maint (CES-67), and receipt photos (CES-40) are implemented. Android M1 is **closed**. Next coding: **CES-41** export. Does not override contract docs — see [cestovni-views.md](cestovni-views.md), [DATA_CONTRACTS.md](DATA_CONTRACTS.md), and [DELIVERY_ACCEPTANCE.md](DELIVERY_ACCEPTANCE.md).
