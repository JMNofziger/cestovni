...
- **Scope:** visual reference for target screens. **Repo:** Log, History, vehicle flows (CES-39), prefs display (CES-65), Metrics (CES-66), and Maint (CES-67) are implemented. Remaining M1 coding: photos (**CES-40**). Does not override contract docs — see [cestovni-views.md](cestovni-views.md), [DATA_CONTRACTS.md](DATA_CONTRACTS.md), and [DELIVERY_ACCEPTANCE.md](DELIVERY_ACCEPTANCE.md).
